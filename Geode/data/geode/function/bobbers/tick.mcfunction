...
execute unless predicate geode:bobbers/mainhand unless predicate geode:bobbers/offhand if entity @n[type=minecraft:fishing_bobber,tag=!cast] run function geode:bobbers/normal
