...
execute as @a[scores={geode_totem_mainhand_switch_timer=1}] at @s if score @s geode_arbitrary_ids = @n[type=marker,tag=player_marker] geode_arbitrary_ids run data modify entity @n[type=marker,tag=player_marker] data.function set from entity @s SelectedItem.components."minecraft:custom_data".function
...
execute as @a[scores={geode_totem_offhand_switch_timer=1}] at @s if score @s geode_arbitrary_ids = @n[type=marker,tag=player_marker] geode_arbitrary_ids run data modify entity @n[type=marker,tag=player_marker] data.function set from entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".function
